...
{
[[nodiscard]] auto createTableStatements(const SqlDialect& dialect, const model::ModelInfo& ownerInfo)
...
#endif
[[nodiscard]] auto dropTableStatements(const SqlDialect& dialect, const model::ModelInfo& ownerInfo)
    -> std::vector<std::string>;
#if defined(ORM_CXX_ENABLE_SQLITE_BACKEND) && ORM_CXX_ENABLE_SQLITE_BACKEND
